...
from game import Game, human, computer, Minimax, Move, InvalidMoveException, MoveCompleted, noone, Choice
...
def test_Minimax_next_move():
    ...
    expectedMoves = {"X________", "_X_______", "__X______", "___X_____", "____X____", "_____X___", "______X__",
                     "_______X_", "________X"}
